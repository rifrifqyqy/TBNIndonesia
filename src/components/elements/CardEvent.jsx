...
export default function CardEvent(props) {
  ...
  return (
    <div className="card w-[170px] lg:w-[310px] flex flex-col bg-white p-2 lg:p-3 rounded-lg shadow-sm  ">
      <div className="w-full h-[210px] lg:h-[360px] top-0 right-0 bg-slate-400 relative rounded-md overflow-hidden">
      ...
      <div className="flex flex-col flex-grow ">
        <h1 className=" text-[14px] lg:text-[20px] font-medium mt-3 uppercase">{title}</h1>
        ...
        <div className="mt-auto flex self-end">
          <ButtonPrimary to={to} className="text-[14px] lg:text-[16px] py-1 lg:py-2 px-2 lg:px-8 mt-3 rounded-md lg:rounded-md text-white">
            Lihat Event
          </ButtonPrimary>
        </div>
      </div>
