...
export default function CardEvent(props) {
  ...
  return (
    <div className="card w-[158px] lg:w-[295px] flex flex-col bg-white p-2 lg:p-3 rounded-lg shadow-sm  ">
      ...
      <div className="flex flex-col flex-grow ">
        <h1 className=" text-[14px] lg:text-[20px] line-clamp-2 font-medium mt-1 lg:mt-3 uppercase">{title}</h1>
