...
export default function CardEvent(props) {
  ...
  return (
    <div className="card w-[310px] flex flex-col bg-white p-3 rounded-lg shadow-sm  ">
      <div className="w-full h-[300px] lg:h-[360px] top-0 right-0 bg-slate-400 relative rounded-md overflow-hidden">
      ...
      <div className="flex flex-col flex-grow ">
        <h1 className=" text-[16px] lg:text-[20px] font-medium mt-3 uppercase">{title}</h1>
        ...
        <div className="mt-auto flex self-end">
          <ButtonPrimary to={to} className="text-[14px] lg:text-[16px] px-4 mt-3 rounded-md text-white">
            Lihat Event
          </ButtonPrimary>
        </div>
      </div>
