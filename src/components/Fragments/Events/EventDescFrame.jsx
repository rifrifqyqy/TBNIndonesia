...
export default function EventDescFrame(props) {
  ...
  return (
    <section className="flex lg:justify-end lg:w-[520px]">
      <div className="rounded-lg border-2 border-slate-200 w-full lg:w-[520px] flex flex-col p-[12px] lg:p-4 divide-y-2 divide-solid">
        <div className="pb-2 break-all">
          <h1 className="text-[16px] lg:text-[24px] font-semibold uppercase">{title}</h1>
          <h2 className="text-[14px] lg:text-[16px] text-gray3">{date}</h2>
          <p className="text-gray4 text-[14px] lg:text-[16px] line-clamp-1">{location}</p>
        </div>
