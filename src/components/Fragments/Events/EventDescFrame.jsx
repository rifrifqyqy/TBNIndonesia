    ...
    <section className="flex lg:justify-end lg:w-[520px]">
      <div className="rounded-lg border-2 border-slate-200 w-full lg:w-[520px] flex flex-col p-4 divide-y-2 divide-solid">
        ...
        <div className="flex justify-between pt-4 gap-2">
          <ButtonPrimary className="border-[1px] border-darkp flex-grow text-center text-white py-2 text-[14px] lg:text-[16px]">Buy Ticket</ButtonPrimary>
          <ButtonPrimary className="bg-transparent border-[1px] border-gray1 flex-grow text-center self-center text-gray1 hover:bg-gray1 hover:text-white py-2 text-[14px] lg:text-[16px]">Learn More</ButtonPrimary>
        </div>
      </div>
    </section>
  );
